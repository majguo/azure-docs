---
title: Integrate your Open Liberty application with Azure managed databases
description: Integrate your Open Liberty application with Azure managed databases.
author: jiangma
ms.author: jiangma
ms.service: container-service
ms.topic: conceptual
ms.date: 07/01/2020
keywords: java, jakartaee, javaee, open-liberty, aro, openshift, red hat, azure, postgresql, mssql
---
